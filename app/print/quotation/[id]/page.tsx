                ...
                <div className="quotation-body">
                    ...
                    <div className="flex justify-between items-start border-b pb-6 mb-8">
                        <div className="w-1/2">
                            ...
                            <div className="font-bold text-lg mb-2">{company?.name || 'Company Name'}</div>
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            <div>
                                ...
                                <ul className="list-disc list-inside text-xs text-gray-600 space-y-1">
                                    ...
                                    <li>Subject to {company?.name || 'Company'} standard service agreement.</li>
                                </ul>
                            </div>
                            <div className="text-right flex flex-col items-end justify-end">
                                ...
                                <div className="text-xs text-gray-500">For {company?.name || 'Company'}</div>
                            </div>
                        </div>
                    </div>
