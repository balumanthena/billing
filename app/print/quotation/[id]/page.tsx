            ...
            <div className="grid grid-cols-2 gap-8">
                ...
                <div className="text-right flex flex-col items-end justify-end">
                    ...
                    <div className="quotation-header">
                        {company?.logo_url && (
                            <img src={company.logo_url} alt={`${company.name} Logo`} className="h-10 mr-4" />
                        )}
                    ...
                    <div className="quotation-body">
                        ...
                        <div className="flex justify-between items-start mb-8">
                            <div>
                                <h2 className="text-3xl font-bold text-gray-800 mb-2">QUOTATION</h2>
                                <div className="text-gray-600">
                                    <span className="font-semibold">Quotation No:</span> {quotation.quotation_no}
                                </div>
                                <div className="text-gray-600">
                                    <span className="font-semibold">Date:</span> {formatDate(quotation.quotation_date)}
                                </div>
                            </div>
